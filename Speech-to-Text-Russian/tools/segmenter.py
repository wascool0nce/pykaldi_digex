...
class Segmenter(object):
    ...
    def extract_segments(self, segments):
        ...
        try:
            ...
            with open(segments, 'r', encoding='utf-8') as s, \
                    open(wav_segments, 'w', encoding='utf-8') as ws, \
                    open(utt2spk, 'w', encoding='utf-8') as u:
                for segment in s:
            ...
            extract_command = "extract-segments scp:" + self.scp + " " + str(self.output / 'segments') + " scp:" + str(
                self.output / 'wav_segments.scp')
